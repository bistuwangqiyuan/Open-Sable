...
describe('ConfigGenerator', () => {
  ...
  describe('OPENSABLE_AGENT_NAME', () => {
    it('should be "opensable"', () => {
  ...
  describe('generateConfig', () => {
    ...
    it('should set default agent to opensable', () => {
      const options: ConfigGeneratorOptions = {
        ...baseOptions,
        mcpToolsPath,
        userDataPath,
      ...
      expect(result.config.default_agent).toBe(OPENSABLE_AGENT_NAME);
    });
    ...
    it('should configure agent with correct mode', () => {
      ...
      expect(result.config.agent?.[OPENSABLE_AGENT_NAME]?.mode).toBe('primary');
    });
  ...
  describe('system prompt content', () => {
    it('should include identity section', () => {
      ...
      expect(result.systemPrompt).toContain('OpenSable');
    });
