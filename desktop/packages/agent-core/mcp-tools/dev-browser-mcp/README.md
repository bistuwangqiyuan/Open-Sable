...
Connects to the dev-browser HTTP server, which manages browser lifecycle and page routing. This is how the OpenSable desktop app uses it.
...
| `OPENSABLE_TASK_ID` | both    | Task ID for page name isolation (default: `default`).         |
