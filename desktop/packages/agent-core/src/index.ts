...
// @opensable/core - Public API (v0.4.0)
// =============================================================================
// This file explicitly exports the public API for the @opensable/core package.
...
// OpenSable gateway adapter
export { OpenSableAdapter, createOpenSableAdapter } from './internal/classes/OpenSableAdapter.js';
export type { OpenSableConfig } from './internal/classes/OpenSableAdapter.js';

// Adapter mode type
export type { AdapterMode } from './internal/classes/TaskManager.js';
...
// -----------------------------------------------------------------------------
// Shared Module (from ./common/) - Merged from @opensable/shared
// -----------------------------------------------------------------------------
