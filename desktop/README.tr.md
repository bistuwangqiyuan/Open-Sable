...
<p align="center">
  <img src="docs/banner.svg" alt="OpenSable - Kendi AI API anahtarlarınızla dosya yönetimi, belge oluşturma ve tarayıcı görevlerini otomatikleştiren açık kaynaklı AI masaüstü ajanı" width="100%" />
</p>
...
<p align="center">
  ...
  <a href="https://github.com/opensable/opensable/commits"><img src="https://img.shields.io/github/last-commit/opensable/opensable?style=flat-square&color=22c55e" alt="Son Commit" /></a>
  <a href="https://downloads.opensable.ai/downloads/0.3.10/macos/OpenSable-0.3.10-mac-arm64.dmg"><img src="https://img.shields.io/badge/Download-macOS_(Apple_Silicon)-0ea5e9?style=flat-square" alt="macOS için İndir (Apple Silicon)" /></a>
  <a href="https://downloads.opensable.ai/downloads/0.3.10/macos/OpenSable-0.3.10-mac-x64.dmg"><img src="https://img.shields.io/badge/Download-macOS_(Intel)-0ea5e9?style=flat-square" alt="macOS için İndir (Intel)" /></a>
  <a href="https://downloads.opensable.ai/downloads/0.3.10/windows/OpenSable-0.3.10-win-x64.exe"><img src="https://img.shields.io/badge/Download-Windows_11-0ea5e9?style=flat-square" alt="Windows 11 için İndir" /></a>
...
# OpenSable™ - Açık Kaynaklı AI Masaüstü Ajanı

OpenSable, bilgisayarınızda yerel olarak dosya yönetimi, belge oluşturma ve tarayıcı görevlerini otomatikleştiren açık kaynaklı bir AI masaüstü ajanıdır. Kendi API anahtarlarınızı (OpenAI, Anthropic, Google, xAI) kullanın veya Ollama üzerinden yerel modeller çalıştırın.
...
<p align="center">
  <a href="https://downloads.opensable.ai/downloads/0.3.10/macos/OpenSable-0.3.10-mac-arm64.dmg"><strong>Mac için İndirin (Apple Silicon)</strong></a>
  ·
  <a href="https://downloads.opensable.ai/downloads/0.3.10/macos/OpenSable-0.3.10-mac-x64.dmg"><strong>Mac için İndirin (Intel)</strong></a>
  ·
...
- OpenSable'e (veya başka birine) hiçbir şey gönderilmez
...
OpenSable bilgisayarınızda yerel olarak çalışır. Dosyalarınız cihazınızda kalır ve hangi klasörlere erişebileceğini siz seçersiniz.
...
[**Mac için İndirin (Apple Silicon)**](https://downloads.opensable.ai/downloads/0.3.10/macos/OpenSable-0.3.10-mac-arm64.dmg) · [**Mac için İndirin (Intel)**](https://downloads.opensable.ai/downloads/0.3.10/macos/OpenSable-0.3.10-mac-x64.dmg) · [**Windows 11 için İndirin**](https://downloads.opensable.ai/downloads/0.3.10/windows/OpenSable-0.3.10-win-x64.exe)
...
macOS'ta OpenSable'e hızlı bir bakış ve kısa bir demo videosu.

<p align="center">
  <a href="https://youtu.be/UJ0FIufMOlc?si=iFcu3VTG4B4q9VCB">
    <img src="docs/video-thumbnail.png" alt="OpenSable demosu - Dosya yönetimi ve tarayıcı görevlerini otomatikleştiren AI ajanı" width="600" />
  </a>
</p>
...
**OpenSable yerel olarak mı çalışıyor?**
Evet. OpenSable bilgisayarınızda yerel olarak çalışır ve hangi klasörlere erişebileceğini kontrol edersiniz.
...
**OpenSable ücretsiz mi?**
Evet. OpenSable açık kaynaklıdır ve MIT lisanslıdır.
...
| `pnpm -F @opensable/desktop test:e2e` | Playwright E2E testleri                           |
