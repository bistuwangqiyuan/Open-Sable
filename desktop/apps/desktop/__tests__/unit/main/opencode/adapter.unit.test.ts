...
// Mock @opensable/agent-core - agent-core package exports used by adapter
...
describe('OpenCode Adapter Module', () => {
  ...
  beforeEach(async () => {
    ...
    // OpenCodeAdapter is now internal to agent-core, get it from the mocked @opensable/agent-core module
    const agentCoreModule = await import('@opensable/agent-core');
