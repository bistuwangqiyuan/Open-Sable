...
// Mock @opensable/agent-core - comprehensive mock covering all exports used by handlers.ts
vi.mock('@opensable/agent-core', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@opensable/agent-core')>();
...
// Note: App settings and provider settings are now mocked via @opensable/core mock above
...
describe('IPC Handlers Integration', () => {
  ...
  describe('Settings Handlers', () => {
    ...
    it('settings:set-debug-mode should update debug mode', async () => {
      ...
      // Assert
      const { setDebugMode } = await import('@opensable/agent-core');
  ...
  describe('Task Handlers', () => {
    ...
    it('task:clear-history should clear all tasks', async () => {
      ...
      // Assert
      const { clearHistory } = await import('@opensable/agent-core');
  ...
  describe('Onboarding Handlers', () => {
    ...
    it('onboarding:set-complete should update onboarding status', async () => {
      ...
      // Assert
      const { setOnboardingComplete } = await import('@opensable/agent-core');
  ...
  describe('Model Handlers', () => {
    ...
    it('model:set should update selected model', async () => {
      ...
      // Assert
      const { setSelectedModel } = await import('@opensable/agent-core');
  ...
  describe('Task Callbacks and Message Batching', () => {
    ...
    it('task:start should save task to history', async () => {
      ...
      // Assert
      const { saveTask } = await import('@opensable/agent-core');
  ...
  describe('Session Resume with Existing Task', () => {
    ...
    it('session:resume should add user message to existing task', async () => {
      ...
      // Assert
      const { addTaskMessage } = await import('@opensable/agent-core');
    ...
    it('session:resume should update task status in history', async () => {
      ...
      // Assert
      const { updateTaskStatus } = await import('@opensable/agent-core');
