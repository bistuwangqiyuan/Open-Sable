...
import type { ProviderType, Skill, TodoItem, McpConnector } from '@opensable/agent-core';

// Expose the opensable API to the renderer
const opensableAPI = {
  // App info
...
contextBridge.exposeInMainWorld('opensable', opensableAPI);
...
contextBridge.exposeInMainWorld('opensableShell', {
...
// Type declarations
export type OpenSableAPI = typeof opensableAPI;
