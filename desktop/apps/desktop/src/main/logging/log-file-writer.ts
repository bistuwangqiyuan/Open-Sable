 ...
 * platform-agnostic LogFileWriter from @opensable/core.
 */

import path from 'path';
import { app } from 'electron';
import { createLogWriter, type LogWriterAPI } from '@opensable/agent-core';

// Re-export types from shared package for backward compatibility
export type { LogLevel, LogSource, LogEntry } from '@opensable/agent-core';
