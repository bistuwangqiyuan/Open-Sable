 ...
 * - Shows "OpenSable" instead of "Electron" in macOS Cmd+Tab and Dock
 * - Registers the "opensable://" URL scheme so OAuth callbacks route to the running dev instance
 */
const fs = require('fs');
const path = require('path');

const APP_NAME = 'OpenSable';
const URL_SCHEME = 'opensable';
...
// Add CFBundleURLTypes for the opensable:// protocol (if not already present)
