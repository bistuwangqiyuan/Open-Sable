...
export function VertexProviderForm({
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      const validation = await opensable.validateVertexCredentials(credentials);
      ...
      // Save credentials
      await opensable.saveVertexCredentials(credentials);

      // Fetch available models
      const credentialsJson = JSON.stringify(credentials);
      const modelsResult = await opensable.fetchVertexModels(credentialsJson);
