...
import type { ProviderId, ConnectedProvider } from '@opensable/agent-core/common';
import { hasAnyReadyProvider, isProviderReady } from '@opensable/agent-core/common';
...
export function SettingsDialog({
  ...
  useEffect(() => {
    ...
    opensable.getDebugMode().then(setDebugModeState);
    // Load app version
    opensable.getVersion().then(setAppVersion);
  }, [open, refetch, opensable]);
  ...
  const handleDebugToggle = useCallback(async () => {
    ...
    await opensable.setDebugMode(newValue);
