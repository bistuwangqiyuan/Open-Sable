...
export function TaskInputBar({
  ...
  return (
    <div className="w-full space-y-2">
      ...
      <div
        className="rounded-[12px] border border-border bg-popover/70 transition-all duration-200 ease-opensable cursor-text focus-within:border-muted-foreground/40"
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  ...
                  className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-full transition-all duration-200 ease-opensable ${
                    isLoading
