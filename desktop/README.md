...
<p align="center">
  <img src="docs/banner.svg" alt="OpenSable - Open source AI desktop agent that automates file management, document creation, and browser tasks with your own AI API keys" width="100%" />
</p>
...
<p align="center">
  ...
  <a href="https://github.com/opensable/opensable/commits"><img src="https://img.shields.io/github/last-commit/opensable/opensable?style=flat-square&color=22c55e" alt="Last Commit" /></a>
  <a href="https://downloads.opensable.ai/downloads/0.3.10/macos/OpenSable-0.3.10-mac-arm64.dmg"><img src="https://img.shields.io/badge/Download-macOS_(Apple_Silicon)-0ea5e9?style=flat-square" alt="Download for macOS (Apple Silicon)" /></a>
  <a href="https://downloads.opensable.ai/downloads/0.3.10/macos/OpenSable-0.3.10-mac-x64.dmg"><img src="https://img.shields.io/badge/Download-macOS_(Intel)-0ea5e9?style=flat-square" alt="Download for macOS (Intel)" /></a>
  <a href="https://downloads.opensable.ai/downloads/0.3.10/windows/OpenSable-0.3.10-win-x64.exe"><img src="https://img.shields.io/badge/Download-Windows_11-0ea5e9?style=flat-square" alt="Download for Windows 11" /></a>
...
# OpenSable™ (formerly Openwork) - Open Source AI Desktop Agent

OpenSable is an open source AI desktop agent that automates file management, document creation, and browser tasks locally on your machine. Bring your own API keys (OpenAI, Anthropic, Google, xAI) or run local models via Ollama.
...
<p align="center">
  <a href="https://downloads.opensable.ai/downloads/0.3.10/macos/OpenSable-0.3.10-mac-arm64.dmg"><strong>Download for Mac (Apple Silicon)</strong></a>
  ·
  <a href="https://downloads.opensable.ai/downloads/0.3.10/macos/OpenSable-0.3.10-mac-x64.dmg"><strong>Download for Mac (Intel)</strong></a>
  ·
...
- Nothing gets sent to OpenSable (or anyone else)
...
OpenSable runs locally on your machine. Your files stay on your device, and you choose which folders it can access.
...
[**Download for Mac (Apple Silicon)**](https://downloads.opensable.ai/downloads/0.3.10/macos/OpenSable-0.3.10-mac-arm64.dmg) · [**Download for Mac (Intel)**](https://downloads.opensable.ai/downloads/0.3.10/macos/OpenSable-0.3.10-mac-x64.dmg) · [**Download for Windows 11**](https://downloads.opensable.ai/downloads/0.3.10/windows/OpenSable-0.3.10-win-x64.exe)
...
A quick look at OpenSable on macOS, plus a short demo video.

<p align="center">
  <a href="https://youtu.be/UJ0FIufMOlc?si=iFcu3VTG4B4q9VCB">
    <img src="docs/video-thumbnail.png" alt="OpenSable demo - AI agent automating file management and browser tasks" width="600" />
  </a>
</p>
...
**Does OpenSable run locally?**  
Yes. OpenSable runs locally on your machine and you control which folders it can access.

**Do I need an API key?**  
You can use your own API keys (OpenAI, Anthropic, Google, xAI, etc.) or run local models via Ollama.

**Is OpenSable free?**  
Yes. OpenSable is open source and MIT licensed.
...
| `pnpm -F @opensable/desktop test:e2e` | Playwright E2E tests        |
