...
<p align="center">
  <img src="docs/banner.svg" alt="OpenSable — открытый ИИ-агент для рабочего стола, автоматизирующий управление файлами, создание документов и задачи в браузере с вашими собственными API-ключами" width="100%" />
</p>
...
<p align="center">
  ...
  <a href="https://github.com/opensable/opensable/commits"><img src="https://img.shields.io/github/last-commit/opensable/opensable?style=flat-square&color=22c55e" alt="Последний коммит" /></a>
  <a href="https://downloads.opensable.ai/downloads/0.3.10/macos/OpenSable-0.3.10-mac-arm64.dmg"><img src="https://img.shields.io/badge/Download-macOS_(Apple_Silicon)-0ea5e9?style=flat-square" alt="Скачать для macOS (Apple Silicon)" /></a>
  <a href="https://downloads.opensable.ai/downloads/0.3.10/macos/OpenSable-0.3.10-mac-x64.dmg"><img src="https://img.shields.io/badge/Download-macOS_(Intel)-0ea5e9?style=flat-square" alt="Скачать для macOS (Intel)" /></a>
  <a href="https://downloads.opensable.ai/downloads/0.3.10/windows/OpenSable-0.3.10-win-x64.exe"><img src="https://img.shields.io/badge/Download-Windows_11-0ea5e9?style=flat-square" alt="Скачать для Windows 11" /></a>
...
# OpenSable™ (ранее Openwork) — открытый ИИ-агент для рабочего стола

OpenSable — это открытый ИИ-агент для рабочего стола, который автоматизирует управление файлами, создание документов и задачи в браузере прямо на вашем компьютере. Используйте свои API-ключи (OpenAI, Anthropic, Google, xAI) или запускайте локальные модели через Ollama.
...
<p align="center">
  <a href="https://downloads.opensable.ai/downloads/0.3.10/macos/OpenSable-0.3.10-mac-arm64.dmg"><strong>Скачать для Mac (Apple Silicon)</strong></a>
  ·
  <a href="https://downloads.opensable.ai/downloads/0.3.10/macos/OpenSable-0.3.10-mac-x64.dmg"><strong>Скачать для Mac (Intel)</strong></a>
  ·
...
- Ничего не отправляется в OpenSable (или кому-либо ещё)
...
OpenSable работает локально на вашем компьютере. Файлы остаются на устройстве, вы выбираете, к каким папкам есть доступ.
...
[**Скачать для Mac (Apple Silicon)**](https://downloads.opensable.ai/downloads/0.3.10/macos/OpenSable-0.3.10-mac-arm64.dmg) · [**Скачать для Mac (Intel)**](https://downloads.opensable.ai/downloads/0.3.10/macos/OpenSable-0.3.10-mac-x64.dmg) · [**Скачать для Windows 11**](https://downloads.opensable.ai/downloads/0.3.10/windows/OpenSable-0.3.10-win-x64.exe)
...
Краткий обзор OpenSable на macOS и короткое демо-видео.

<p align="center">
  <a href="https://youtu.be/UJ0FIufMOlc?si=iFcu3VTG4B4q9VCB">
    <img src="docs/video-thumbnail.png" alt="Демо OpenSable — ИИ-агент автоматизирует управление файлами и задачи в браузере" width="600" />
  </a>
</p>
...
**OpenSable работает локально?**  
Да. OpenSable запускается на вашем компьютере, и вы сами задаёте папки, к которым у него есть доступ.

**Нужен ли API-ключ?**  
Можно использовать свои API-ключи (OpenAI, Anthropic, Google, xAI и др.) или запускать локальные модели через Ollama.

**OpenSable бесплатный?**  
Да. OpenSable — открытый проект с лицензией MIT.
...
| `pnpm -F @opensable/desktop test:e2e` | E2E-тесты Playwright          |
